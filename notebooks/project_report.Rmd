---
title: "Impact of Global Warming in Finland"
output: pdf_document
...
After pre-processing the data consists of one mean sea-level value per year. The example can be found in Figure 4. Visual representation of this processed data is plotted below for all 4 cities.
